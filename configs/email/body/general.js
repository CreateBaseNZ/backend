...
<b><a href="${process.env.PREFIX_APP}/auth/verify?email=${object.recipient}&code=${object.code}">Click this link</a></b> to verify your account.

Or, you can enter your verification code <b><a href="${process.env.PREFIX_APP}/auth/verify">here</a></b>.`,
	];
};
...
general.passwordReset = function (object = {}) {
	return [
		...
		`Click <b><a href='${process.env.PREFIX_APP}/auth/forgot-password?email=${object.recipient}&code=${object.code}'>this link</a></b> to change your password.`,
	];
};
...
<u><b><a href="${process.env.PREFIX_APP}/browse">Browse Projects ></a></b></u>
...
<u><b><a href="${process.env.PREFIX_APP}/manage-group/students">Manage Groups ></a></b></u>`,
	];
};
