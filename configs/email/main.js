...
let email = {
	...
	send: undefined,
	alias: {
		carl: '"Carl from CreateBase" <carl@createbase.co.nz>',
		brad: '"Bradley from CreateBase" <brad@createbase.co.nz>',
		brydon: `"Brydon from CreateBase" <brydon@createbase.co.nz>`,
		craig: `"Craig from CreateBase" <craig@createbase.co.nz>`,
		louis: `"Louis from CreateBase" <louis@createbase.co.nz>`,
		weiwei: `"Weiwei from CreateBase" <weiwei@createbase.co.nz>`,
